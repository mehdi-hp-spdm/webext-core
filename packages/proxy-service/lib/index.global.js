...
var webExtCoreProxyService = (() => {
  ...
  // ../messaging/lib/chunk-BQLFSFFZ.js
  ...
  function defineExtensionMessaging(config) {
    return defineGenericMessanging(__spreadProps(__spreadValues({}, config), {
      sendMessage(message, arg) {
        if (arg == null) {
          return import_webextension_polyfill2.default.runtime.sendMessage(message);
        }
        const options = typeof arg === "number" ? { tabId: arg } : arg;
        if (typeof options.tabId !== "number") {
          throw new Error("tabId is required when sending a message to a tab");
        }
        return import_webextension_polyfill2.default.tabs.sendMessage(
          options.tabId,
          message,
      ...
      addRootListener(processMessage) {
        ...
        return () => import_webextension_polyfill2.default.runtime.onMessage.removeListener(listener);
      }
    }));
  }
